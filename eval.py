...
experimental_name = 'full data(xception)_3layer' #'small data(vgg)_3layer' #'small data(xeption)'  # "san_2lstm_all"
...
def plot_att(img, q, a, pred, att1, att2, att3, path):
    ...
    ax.set_title(title3)
    img = ax.imshow(temp_image)
    ax.imshow(att3, cmap='gray', alpha=0.6, extent=img.get_extent())
...
def save_result(batch,
    ...
    for i in range(prediction.shape[0]):
        ...
        plot_att(fig_path, clean_que, ans, pred, w1, w2, w3, att_img_path)
